...
<title>Update ItemRate</title>
</head>
<body>
	<%
	ItemRateBean bean = (ItemRateBean)request.getAttribute("itemrateBean");
	%>
	<form action="controller?page=ItemRateUpdate" method="post">
		Branch GroupId : <input type="text" name="brnachGroupId" value="<%=bean.getBranchGroupId() %>"><br>
